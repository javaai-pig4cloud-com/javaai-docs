...
public ChatAssistant chatAssistant(ChatModel chatModel) {
    ...
    return AiServices.builder(ChatAssistant.class).chatModel(chatModel).tools(webSearchTool).build();
}
```
...
<Card title="文档有误？请协助编辑" icon="pencil" href="https://github.com/javaai-pig4cloud-com/javaai-docs/edit/main/docs/18-web-search.mdx">
  发现文档问题？点击此处直接在 GitHub 上编辑并提交 PR，帮助我们改进文档！
</Card>
