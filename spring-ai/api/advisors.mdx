...
You can configure existing advisors using the [ChatClient API](/spring4ai/api/chatclient#advisor-configuration-in-chatclient) as shown in the following example:
...
- [Learn about Question Answer Advisor](/spring4ai/api/retrieval-augmented-generation#questionansweradvisor)
- [Learn about Chat Memory Advisor](/spring4ai/api/chat-memory#memory-in-chat-client)
...
<Frame caption="Advisors API Classes">
...
<Frame caption="Advisors API Flow">
...
<AccordionGroup>
  <Accordion title="Order of Execution" icon="sort-numeric-down">
  ...
  <Accordion title="Controlling Execution Order" icon="sliders-h">
...
We will provide a few hands-on examples to illustrate how to implement advisors for observing and augmenting use-cases.
...
This implementation supports both non-streaming and streaming scenarios.
...
<AccordionGroup>
  <Accordion title="Chat Memory Advisors" icon="memory">
  ...
  <Accordion title="Question Answering Advisor" icon="question-circle">
    <CardGroup cols={1}>
  ...
  <Accordion title="Content Safety Advisor" icon="shield-alt">
    <CardGroup cols={1}>
...
<Frame caption="Advisors Streaming vs Non-Streaming Flow">
...
Example of implementing a streaming advisor with blocking and non-blocking code:
...
<Tabs>
  <Tab title="1.0 M2">
    * Separate `RequestAdvisor` and `ResponseAdvisor` interfaces
    ...
    * Used `StreamResponseMode` as part of `ResponseAdvisor`
  </Tab>
  <Tab title="1.0 M3">
    * Replaced with `CallAroundAdvisor` and `StreamAroundAdvisor`
    * `StreamResponseMode` has been removed
  </Tab>
</Tabs>
