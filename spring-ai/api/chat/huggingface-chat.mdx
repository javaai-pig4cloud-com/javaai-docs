...
The [HuggingfaceChatModel](https://github.com/spring-projects/spring-ai/blob/main/models/spring-ai-huggingface/src/main/java/org/springframework/ai/huggingface/HuggingfaceChatModel.java) implements the `ChatModel` interface and uses the low-level API to connect to the Hugging Face inference endpoints.
