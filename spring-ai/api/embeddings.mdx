...
The Embedding Model API is built on top of the generic [Spring AI Model API](https://github.com/spring-projects/spring-ai/tree/main/spring-ai-model/src/main/java/org/springframework/ai/model), which is a part of the Spring AI library.
...
![Embeddings API](embeddings-api.jpg)
...
* [Spring AI OpenAI Embeddings](/spring4ai/api/embeddings/openai-embeddings)
* [Spring AI Azure OpenAI Embeddings](/spring4ai/api/embeddings/azure-openai-embeddings)
* [Spring AI Ollama Embeddings](/spring4ai/api/embeddings/ollama-embeddings)
* [Spring AI Transformers (ONNX) Embeddings](/spring4ai/api/embeddings/onnx)
* [Spring AI PostgresML Embeddings](/spring4ai/api/embeddings/postgresml-embeddings)
* [Spring AI Bedrock Cohere Embeddings](/spring4ai/api/embeddings/bedrock-cohere-embedding)
* [Spring AI Bedrock Titan Embeddings](/spring4ai/api/embeddings/bedrock-titan-embedding)
* [Spring AI VertexAI Embeddings](/spring4ai/api/embeddings/vertexai-embeddings-text)
* [Spring AI Mistral AI Embeddings](/spring4ai/api/embeddings/mistralai-embeddings)
* [Spring AI Oracle Cloud Infrastructure GenAI Embeddings](/spring4ai/api/embeddings/oci-genai-embeddings) 