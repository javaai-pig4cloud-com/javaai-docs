---
title: "Oracle Cloud Infrastructure (OCI) GenAI Embeddings"
---
...
<Tip>
All properties prefixed with `spring.ai.oci.genai.embedding.options` can be overridden at runtime by adding a request specific [embedding options](#embedding-options) to the `EmbeddingRequest` call.
</Tip>
